...
export function AuthProvider({ children }) {
  ...
  const signIn = async (email, password) => {
    ...
    // Block deactivated accounts at sign-in, not just in the UI — an admin
    // toggling someone off in the Users & Roles page should actually stop
    // that person from getting in, not just hide their profile.
